...
#include <FeatherCdh/FeatherCdhDesktopDeployment/Top/FeatherCdhDesktopDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    FeatherCdh::startRateGroups(Fw::TimeInterval(0, 100000));  // 100 ms = 10 Hz base tick (÷1 → 10 Hz, ÷10 → 1 Hz)
