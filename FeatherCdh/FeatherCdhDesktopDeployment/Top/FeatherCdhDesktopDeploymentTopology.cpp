// ======================================================================
// \title  FeatherCdhDesktopDeploymentTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <FeatherCdh/FeatherCdhDesktopDeployment/Top/FeatherCdhDesktopDeploymentTopologyAc.hpp>
...
// Divide the 100 ms base tick into a 10 Hz group (divisor 1) and a 1 Hz group (divisor 10).
Svc::RateGroupDriver::DividerSet rateGroupDivisorsSet{{{1, 0}, {10, 0}}};

// Rate groups may supply a context token to each of the attached children whose purpose is set by the project.
// Both are set to zero as these contexts are unused in this project.
