// ======================================================================
// \title  FeatherCdhDesktopDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef FEATHERCDHDESKTOPDEPLOYMENT_FEATHERCDHDESKTOPDEPLOYMENTTOPOLOGY_HPP
#define FEATHERCDHDESKTOPDEPLOYMENT_FEATHERCDHDESKTOPDEPLOYMENTTOPOLOGY_HPP
// Included for access to FeatherCdhDesktopDeployment::TopologyState and FeatherCdhDesktopDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <FeatherCdh/FeatherCdhDesktopDeployment/Top/FeatherCdhDesktopDeploymentTopologyDefs.hpp>
 ...
 * FeatherCdhDesktopDeployment::TopologyState see: FeatherCdhDesktopDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type FeatherCdh::TopologyState see: FeatherCdhTopologyDefs.hpp.
 *
