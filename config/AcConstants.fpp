# ======================================================================
# AcConstants.fpp
# Project-level overrides for F Prime autocoder constants.
# Replaces lib/fprime/default/config/AcConstants.fpp via
# CONFIGURATION_OVERRIDES in the root CMakeLists.txt.
# ======================================================================

@ Number of rate group member output ports for ActiveRateGroup
@ Raised from 10 to 12: the 1 Hz group drives 12 components.
